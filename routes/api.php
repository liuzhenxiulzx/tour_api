...
Route::middleware(['jwt'])->group(function () {
  ...
  // 增加收藏数量
  Route::post('addcollenumber', 'ArticleController@addcollenumber');
  // 个人收藏
  Route::get('personalcolle/{id}', 'CollectController@personalcolle');

  // 获取我的文章
  Route::get('myarticles/{id}', 'ArticleController@myarticle');
  // 获取个人信息
  Route::get('personalName/{id}', 'UserController@personalName');
  // 修改个人信息
  Route::post('Personalnews', 'UserController@editPersonalnews');
  // 修改背景图片
  Route::post('backgroundimg', 'UserController@backgroundimg');
